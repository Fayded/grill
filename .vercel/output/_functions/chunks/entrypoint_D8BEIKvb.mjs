import { aj as clientAddressSymbol, A as AstroError, as as LocalsNotAnObject, D as DEFAULT_404_COMPONENT, at as REROUTABLE_STATUS_CODES, j as REROUTE_DIRECTIVE_HEADER, an as responseSentSymbol, au as getAugmentedNamespace, av as commonjsGlobal } from './astro/server_pDgY8W89.mjs';
import { l as ensure404Route } from './astro-designed-error-pages_BzXQ6ng2.mjs';
import { l as levels, g as getEventPrefix, P as Pipeline, c as createStylesheetElementSet, a as createModuleScriptElement, L as Logger, A as AstroIntegrationLogger, b as createDefaultRoutes, d as createAssetLink, e as apply } from './polyfill_mghF4AWi.mjs';
import { Http2ServerResponse } from 'node:http2';
import { r as removeTrailingForwardSlash, p as prependForwardSlash, j as joinPaths, a as appendForwardSlash, c as collapseDuplicateTrailingSlashes, h as hasFileExtension } from './path_CzpST-x-.mjs';
import { l as findRouteToRewrite, m as matchRoute, e as normalizeTheLocale, p as RenderContext, P as PERSIST_SYMBOL, q as getSetCookiesFromResponse } from './server_M9g32lm7.mjs';
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_Dz4-A_05.mjs';
